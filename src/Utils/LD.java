...
public class LD
{
    //A private default constructor since there is no reason to create a LD object
    //given all methods are static
    private LD()
    {        
    }
     ...
     */
    public static double calculate(byte[] d1, byte[] d2)
    {
    ...
    private static double maxpAB(int[][] counts, double pA, double pB)
    {
    ...
    private static double calculateLD(double pA, double pB, double pAB)
    {
        double D = pAB - pA * pB;
    ...
    private static double l(double pAB, int[][] counts, double pA, double pB)
    {
        double pAb = pA - pAB;
        double paB = pB - pAB;
